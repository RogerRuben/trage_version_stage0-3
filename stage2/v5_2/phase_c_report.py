...
REPORT_SCHEMA_VERSION = "stage2_v5_2_phase_c_report.1"
EVIDENCE_SCHEMA_VERSION = "stage2_v5_2_phase_c_evidence_bundle.1"
...
def classify_phase_c_direction(decision: Mapping[str, Any], *, pace_guard_pass: bool) -> str:
    ...
    if wins >= 3 and mean_improvement > 0 and pace_guard_pass:
        return "WEAK"
    return "FAIL"
...
def build_phase_c_report(repo_root: str | Path) -> dict[str, Any]:
    ...
    report: dict[str, Any] = {
        ...
        "interpretation": (
            "Support-aware transfer is weak/preliminary on the development window: "
            "M4 wins three low-support targets versus M1 but misses the 2% mean-improvement gate, "
            "and the frozen overall-stability and unseen-versus-M2 gates do not pass."
        ),
    }
...
def render_markdown(report: Mapping[str, Any]) -> str:
    ...
    lines.extend([
        ...
        "`C-WEAK`: structured transfer remains modestly useful, while support-aware gating evidence "
        "is weak/preliminary and does not justify adoption or retuning.", "",
        "## Runtime and memory", "",
...
def build_evidence_bundle(
    ...
    bundle: dict[str, Any] = {
        ...
        "status": "PASS",
        "phase_c_direction": _read_json(report_json_path)["phase_c_direction"],
        ...
        "frozen_bindings": {
            ...
            "phase_c_config": _descriptor(root / "stage2/config/stage2_v5_2.json", root),
...
def main(argv: list[str] | None = None) -> int:
    ...
    json_path, markdown_path, evidence_path = (
